...
WebUI.setText(findTestObject('Object Repository/Page_STORE/Payment/inputloginusername'), 'testhamzah')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_STORE/Payment/inputloginpassword'), 'I9IMA4PskEQrLEpyBR1jvA==')

WebUI.click(findTestObject('Object Repository/Page_STORE/Payment/button_Log in'))

WebUI.click(findTestObject('Object Repository/Page_STORE/Payment/a_Nexus 6'))
...
WebUI.setText(findTestObject('Object Repository/Page_STORE/Payment/inputname'), 'Hamzah')
...
WebUI.setText(findTestObject('Object Repository/Page_STORE/Payment/inputcard'), '123456789')

WebUI.setText(findTestObject('Object Repository/Page_STORE/Payment/inputmonth'), '12')

WebUI.setText(findTestObject('Object Repository/Page_STORE/Payment/inputyear'), '2026')
